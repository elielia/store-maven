...
export const loadTeamsRequest = createAction('[Task Schedule Component] Load Teams request');
...
export const loadTeamsFailed = createAction('[Task Schedule Component] Load Teams failed');
